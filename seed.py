...
def response(cmd, curr_level, stage_dict, img_dict):
    ...
    if cmd == "water" or cmd == "rain":
        ...
        #now animate rain
        drop_list = []
        drop_list.append(pg.draw.line(screen, BLUE, [580,70], [560,85], 3))
        drop_list.append(pg.draw.line(screen, BLUE, [700,70], [680,85], 3))
        drop_list.append(pg.draw.line(screen, BLUE, [640,70], [620,85], 3))
        pg.display.update(drop_list)
        pg.time.delay(520)
        drop_list = []
        drop_list.append(pg.draw.line(screen, WHITE, [580,70], [560,85], 3))
        drop_list.append(pg.draw.line(screen, WHITE, [700,70], [680,85], 3))
        drop_list.append(pg.draw.line(screen, WHITE, [640,70], [620,85], 3))
        pg.display.update(drop_list)
        pg.time.delay(360)
        drop_list = []
        drop_list.append(pg.draw.line(screen, BLUE, [590,120], [570,135], 3))
        drop_list.append(pg.draw.line(screen, BLUE, [710,120], [690,135], 3))
        drop_list.append(pg.draw.line(screen, BLUE, [650,120], [630,135], 3))
        pg.display.update(drop_list)
        pg.time.delay(500)
        drop_list = []
        drop_list.append(pg.draw.line(screen, WHITE, [590,120], [570,135], 3))
        drop_list.append(pg.draw.line(screen, WHITE, [710,120], [690,135], 3))
        drop_list.append(pg.draw.line(screen, WHITE, [650,120], [630,135], 3))
        pg.display.update(drop_list)
        pg.time.delay(250)
        drop_list = []
        drop_list.append(pg.draw.line(screen, BLUE, [580,155], [600,160], 3))
        drop_list.append(pg.draw.line(screen, BLUE, [603,160], [607,155], 3))
        drop_list.append(pg.draw.line(screen, BLUE, [658,151], [660,160], 3))
        drop_list.append(pg.draw.line(screen, BLUE, [663,160], [667,155], 3))
        drop_list.append(pg.draw.line(screen, BLUE, [661,160], [662,148], 1))
        drop_list.append(pg.draw.line(screen, BLUE, [661,142], [662,135], 1))
        pg.display.update(drop_list)
        pg.time.delay(450)
        drop_list = []
        drop_list.append(pg.draw.line(screen, WHITE, [580,155], [600,160], 3))
        drop_list.append(pg.draw.line(screen, WHITE, [603,160], [607,155], 3))
        drop_list.append(pg.draw.line(screen, WHITE, [658,151], [660,160], 3))
